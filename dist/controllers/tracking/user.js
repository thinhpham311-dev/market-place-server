...
var updateUser = exports.updateUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, reply) {
    var userId, updateData, user, UserModel, updatedUser, _handleError, statusCode, message, details;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 17:
          ...
          UserModel = _user.DeliveryPartner;
          _context.next = 22;
          break;
        case 21:
          return _context.abrupt("return", reply.status(403).send({
        ...
        case 30:
          ...
          _handleError = (0, _errorHandler.handleError)(_context.t1), statusCode = _handleError.statusCode, message = _handleError.message, details = _handleError.details;
