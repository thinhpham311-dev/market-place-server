...
exports.buildAdminRouter = exports.admin = void 0;
var _adminjs = _interopRequireDefault(require("adminjs"));
var _fastify = _interopRequireDefault(require("@adminjs/fastify"));
...
_adminjs["default"].registerAdapter(AdminJSMongoose);
var admin = exports.admin = new _adminjs["default"]({
  resources: [{
    resource: Models.Customer,
    options: {
      parent: _icons.userParent,
...
var buildAdminRouter = exports.buildAdminRouter = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(app) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return _fastify["default"].buildAuthenticatedRouter(admin, {
            authenticate: _config.authenticate,
            cookiePassword: _config.COOKIE_PASSWORD,
            cookieName: 'adminjs'
          }, app, {
            store: _config.sessionStore,
            saveUnintialized: true,
            secret: _config.COOKIE_PASSWORD,
            cookie: {
  ...
  return function buildAdminRouter(_x) {
